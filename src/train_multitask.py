...
def train_multitask_unweighted_model():
    ...
    train_dataset, dev_dataset, lid2id, id2lid, pos2id, id2pos = load_and_preprocess_data(
        'multitask')
    ...
    print(
        f"Saving fine-tuned joint multitask (un)weighted model to {model_save_path}")
