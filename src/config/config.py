...
# Model save paths
SINGLE_TASK_POS_SAVE_PATH = os.path.join(
    MODEL_SAVE_DIR, 'single_task_pos-final')
SINGLE_TASK_LID_SAVE_PATH = os.path.join(
    MODEL_SAVE_DIR, 'single_task_lid-final')
SEQUENTIAL_POS_LID_SAVE_PATH = os.path.join(
    MODEL_SAVE_DIR, 'sequential_pos_lid-final')
SEQUENTIAL_LID_POS_SAVE_PATH = os.path.join(
    MODEL_SAVE_DIR, 'sequential_lid_pos-final')
MULTITASK_UNWEIGHTED_SAVE_PATH = os.path.join(
    MODEL_SAVE_DIR, 'multitask_unweighted-final')
MULTITASK_WEIGHTED_SAVE_PATH = os.path.join(
    MODEL_SAVE_DIR, 'multitask_weighted-final')
...
# Evaluation Metrics
# Same for sequential and single-task
METRIC_FOR_BEST_MODEL_SINGLE_TASK = "eval_f1"
...
# Set to True for uncertainty-based weighting (Kendall et al., 2018)
